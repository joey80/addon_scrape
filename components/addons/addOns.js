module.exports = {
  addOns: [
    ...
    },
    {
      ...
      element:
        'div.block-changelog:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > a:nth-child(2)',
    },
    {
      name: 'Calendar',
      url: 'http://docs.solspace.com/expressionengine/calendar/v3/setup/changelog.html',
      element:
        'html body div#app div.theme-container main.page div.content.default h2:first-of-type',
    },
    // {
    //     "name": "CartThrob",
    ...
    // },
    {
      ...
      element:
        'div.software-info:nth-child(3) > div:nth-child(1) > div:nth-child(1) > span:nth-child(2)',
    },
    {
      name: 'Channel Files',
